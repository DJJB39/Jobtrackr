...
const BulkActionBar = ({ selectedCount, onMove, onDelete, onClear }: BulkActionBarProps) => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 rounded-xl border border-border bg-card/95 backdrop-blur-md px-5 py-3 shadow-2xl">
